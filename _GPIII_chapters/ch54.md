...
{% assign translators = "Friedländer,Pines,Goodman,Munk,Atay,Ibn Tibbon" | split: "," %}

<div class="tabs-container">
  <div class="tab-nav">
    {% for t in translators %}
    <button class="tab-button {% if forloop.first %}active{% endif %}" 
            onclick="openTab(event, '{{ t | slugify }}-{{ page.chapter }}')">
      {{ t }}
    </button>
    {% endfor %}
  </div>
