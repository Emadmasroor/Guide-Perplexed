...
<div class="tabs-container">
  <div class="tab-nav">
    <button class="tab-button active" onclick="openTab(event, 'friedlander')">Friedländer</button>
    <button class="tab-button" onclick="openTab(event, 'pines')">Pines</button>
  </div>

  <div id="friedlander" class="tab-panel active" markdown="1">
  Friedländer's translation of this passage goes here...
  </div>

  <div id="pines" class="tab-panel" markdown="1">
  Pines' translation of this passage goes here...
  </div>
</div>
