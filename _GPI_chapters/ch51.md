...
<div class="tabs-container">
  <div class="tab-nav">
    <button class="tab-button active" onclick="openTab(event, 'tab1')">Friedlander</button>
    <button class="tab-button" onclick="openTab(event, 'tab2')">Pines</button>
  </div>

<div id="tab1" class="tab-panel active" markdown="1">
Friedlander text goes here.
</div>

<div id="tab2" class="tab-panel" markdown="1">
Pines text goes here.
</div>
</div>
